...
| D-014 | 2026-09-09 | Le contrôle de configuration ne doit jamais inférer des services réels du seul environnement Preview ou d'un transport e-mail journalisé ; toute preuve runtime reste distincte. | Supprimer les faux positifs sans confondre configuration, livraison et validation produit. Voir `../11-status/readiness-2026-09-09.md`. | Correctif sur branche séparée ; validation complète requise |
