...
| D-021 | 2026-09-12 | L'image basse définition est rejetée ; générer un intérieur haut de gamme, sans insérer de solution provisoire non validée. Distinguer inscription et retour avec identifiants permanents, sans OTP obligatoire à chaque connexion. Le sens de « code » reste à confirmer. | Correction explicite du propriétaire, consignée sans extrapolation technique. | Actif |
