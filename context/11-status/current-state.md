...
Le propriétaire limite désormais le travail au seul bloc authentification : création et retour par code e-mail à six chiffres, plus Google, sans mot de passe ni TOTP imposé dans l’interface. La source `0af7c261` est `READY` sur Preview ; écrans publics, thèmes et absence d’erreur au chargement sont vérifiés. La réception et la saisie privée du code, Google avec un compte réel et les appareils physiques restent `NOT_RUN`. `main`, la production et les autres parcours demeurent inchangés. Détails : [auth-simple-preview-2026-09-23.md](auth-simple-preview-2026-09-23.md).
