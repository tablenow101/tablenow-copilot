...
Preview sert `998acc9f74899904573326a66d3294750a3a56ce`, déploiement `dpl_Hqa6xwfzavPBWR9hFHH49XsjjMg9` READY. Cockpit guidé, conseil sourcé et envoi explicite avec réponse persistante vérifiés en session existante. Un correctif supplémentaire conserve le choix vocal à la reprise et empêche de confirmer une préférence reportée : sept tests PGlite passent après reproduction des trois défauts. La recette révèle aussi un retour erroné à Systèmes après rechargement de Connexions : correctif URL testé, redéploiement en cours. Nouvelle inscription et téléphone physique restent non vérifiés.
