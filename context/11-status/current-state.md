...
Preview sert bien `543c47fd2451eaca7716c3c3e33e0e579511e7c4`, déploiement `dpl_ALSusSfUDgSrxCo3X9B9h7UXeHrL` READY, branche `product/onboarding-owner` (lecture Vercel du 21 septembre). Le dashboard est accessible avec la session existante. « Tout est clair » a été reproduit sans preuve d'évaluation sur Décisions : verdict `WRONG_FLOW`. Cela ne valide pas une nouvelle inscription.
