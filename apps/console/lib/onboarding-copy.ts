...
const labelsFr: Record<string, string> = {
  ...
  thefork: "TheFork", no_software: "Je n'en ai pas", paper: "Dans un cahier", calendar: "Dans un calendrier",
...
export const onboardingCopy: Record<LocaleMode, OnboardingCopy> = {
  fr: {
    ...
    common: {
      ...
      voiceUnavailable: "La dictée n'est pas disponible sur cet environnement.", voiceFailed: "La transcription n'a pas abouti.", establishmentEyebrow: "Établissement", welcome: "Bienvenue.",
